...
public class Ventana_principal extends JFrame implements ActionListener {
    ...
    */
    public void actionPerformed(ActionEvent evento) {
        ...
        Ventana_esfera esfera = new Ventana_esfera(); /* Crea la 
        ...
        if (evento.getSource() == cilindro) { /* Si se pulsa el botón 
            cilindro */
        Ventana_cilindro cilindro = new Ventana_cilindro(); /* Crea la 
        ...
        pirámide */
        Ventana_piramide pirámide = new Ventana_piramide(); /* Crea 
